  ...
  return (
    <MobileLayout>
      ...
      <Box sx={{ flex: 1, bgcolor: 'common.white', display: 'flex', flexDirection: 'column', p: 3 }}>
        ...
        {/* Title */}
        <Typography variant="h2" sx={{ textAlign: 'center', color: 'secondary.main', mt: 2, mb: 1, fontWeight: 'bold' }}>
          Chọn loại tài khoản
        </Typography>
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
          ...
          >
            <Box sx={{ width: 64, height: 64, bgcolor: 'secondary.main', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', mr: 3 }}>
          ...
          >
            <Box sx={{ width: 64, height: 64, bgcolor: 'rgba(255, 107, 0, 0.1)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', mr: 3 }}>
