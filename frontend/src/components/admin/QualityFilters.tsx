...
export default function QualityFilters({ filters: initialFilters, companies, onApply, loading }: QualityFiltersProps) {
  ...
  const companyOptions = [
    { id: 'all', label: 'Tất cả công ty cứu hộ' },
    ...companies.map((c) => ({ id: c._id, label: c.company_name })),
  ];
